          ...
          <h3 className="title">Valorização da vida em tempo real</h3>
           ...
           <div className="login-loginEmail">
            ...
            <div className="login-loginPassword">
               ...
               <Link to="/Home" ><button className="enter-app1">Entrar</button></Link>
            
               
            

               <label className="recordPassword">
                  <input className="checkBoxMemorizer"type="checkbox"  placeholder="Lembrar senha!"defaultChecked={false} />
